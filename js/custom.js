...
$(function() {
  ...
  $(".navbar .collapse-menu").on("click", "span", function() {
    $(".navbar")
      .toggleClass("small-menu")
      .toggleClass("default-menu");
    sections.toggleClass("close-menu");
    $(".collapse-icon")
      .toggleClass("closed-menu")
  ...
  colors
    .eq(0)
    .css("backgroundColor", "#b0914f")
    .end()
    .eq(1)
    .css("backgroundColor", "#7ca95c")
    .end()
    .eq(2)
    .css("backgroundColor", "#d88b7c")
    .end()
    .eq(3)
    .css("backgroundColor", "#55aea1")
    .end()
    .eq(4)
    .css("backgroundColor", "#7a81ce");
  ...
  $(".option-box .gear-check").on("click", function(e) {
    ...
    if ($(this).hasClass("slide_in_out")) {
      ...
      $(".color-option")
        .stop()
        .animate({ right: "-190px" }, 500);
    } else {
      $(".option-box")
        .stop()
        .animate({ right: "178px" }, 500);
      $(".color-option")
        .stop()
        .animate({ right: "0" }, 500);
    }
